...
const page = () => {
  return (
    <div className='bg-[#e9e9e7]'>
      ...
      {/* Part One */}
      <div className='flex flex-row items-center justify-center gap-2.5 h-min overflow-hidden lg:md:p-[100px_40px] p-[60px_20px]  relative w-full'>
          ...
          <div className='flex flex-col items-center justify-center gap-5 h-min overflow-hidden p-0 relative w-full'>
            <div className='flex flex-col items-center justify-center gap-0 h-min overflow-hidden p-0 relative lg:md:w-[650px] w-full'>
              ...
              <div className='flex flex-col justify-start flex-shrink-0 transform-none flex-none h-auto relative whitespace-pre-wrap w-full break-words overflow-wrap break-word outline-none'>
                <h1 className='lg:md:text-[42px] text-[32px] text-[#0d0d0d] text-center leading-[1.2em] font-medium font-Plus_Jakarta_Sans'>Ideas, insights, perspectives, and other notes</h1>
              </div>
            </div>
      ...
      {/* Part Two */}
      <div className='flex items-center justify-center flex-row gap-2 h-min overflow-hidden lg:md:px-10 px-5 lg:md:pb-24 pb-[60px] pt-0 relative w-full'>
