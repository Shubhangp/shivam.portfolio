...
const HeaderStaticWork = () => {
    const contentRef = useRef(null);
    const [navOpen, setNavOpen] = useState(false);

    return (
        <div className='contents'>
            <header className={`w-full relative lg:md:py-[30px] lg:md:px-10 px-5 flex flex-row items-center justify-center flex-nowrap gap-[10px] overflow-hidden backdrop-blur-[10px] ${!navOpen ? 'py-[25px]' : `bg-[#0d0d0d] pt-[30px] pb-[50px]`} transition-all duration-500 ease-in-out opacity-100`}>
...
export default HeaderStaticWork;