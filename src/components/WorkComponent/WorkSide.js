            ...
            <div id="partOne" className='flex flex-row items-center justify-center gap-2.5 h-min overflow-hidden lg:md:p-[100px_40px] p-[60px_20px] relative w-full'>
                <div className='place-content-center flex flex-col items-center justify-center gap-20 flex-[1_0_0px] h-min max-w-[1200px] overflow-hidden relative lg:md:w-[1px] w-full'>
                    <div className='flex flex-col items-center justify-center gap-5 h-min overflow-hidden p-0 relative w-full'>
                        <div className='flex flex-col items-center justify-center gap-0 h-min overflow-hidden p-0 relative lg:md:w-[550px] w-full'>
                        ...
                        <div className='outline-none flex flex-col justify-start flex-shrink-0 transform-none flex-none h-auto relative whitespace-pre-wrap lg:md:w-[600px] w-full break-words overflow-wrap'>
            ...
            <div id="partFour" className='flex place-content-center items-center flex-none flex-row gap-2 h-min overflow-hidden lg:md:p-[100px_40px] p-[60px_20px] relative w-full border-t border-[#0d0d0d80]'>
                <div className='flex place-content-center items-center flex-grow flex-shrink-0 flex-col gap-12 h-min max-w-[1200px] overflow-visible p-0 relative lg:md:w-[1px] w-full'>
                    ...
                    <div className='place-content-center items-center hidden lg:md:flex flex-none flex-col gap-0 h-min overflow-visible p-0 relative w-full'>
                        {playGround.map((data, index) => (<div key={index} className='flex-none h-auto relative w-full'>
